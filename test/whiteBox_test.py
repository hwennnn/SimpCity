...
def test_whiteBox_flow1(capfd):
    ...
    assert game.player.grid.colCount == game.player.grid.rowCount == 4
...
def test_whiteBox_flow2(capfd):
    ...
    game = Game()
    game.player.updateGridSize("3,3")

    assert game.player.grid.rowCount == game.player.grid.colCount == 3
    ...
    assert game.player.grid.availableBuildings.availability[factoryIndex] == 6
    assert game.player.grid.availableBuildings.availability[beachIndex] == 7
    assert game.player.grid.availableBuildings.availability[houseIndex] == 7
    assert game.player.grid.availableBuildings.availability[highwayIndex] == 5
    assert game.player.grid.availableBuildings.availability[shopIndex] == 6

    game.leaderboard.saveScoreIntoLeaderboard(game.player.retrieveBuildingsScore(
        False), game.player.grid.rowCount, game.player.grid.colCount, "newh")
    out, _ = capfd.readouterr()
    assert "Congratulations! You made the high score board at position 1!" in out
    assert len(game.leaderboard.leaderboard[3][3]) == 1
    assert game.leaderboard.leaderboard[3][3][0].name == "newh" and game.leaderboard.leaderboard[3][3][0].score
...
def test_whiteBox_flow3(capfd):
    ...
    assert game.player.grid.colCount == game.player.grid.rowCount == 2
